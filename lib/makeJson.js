    ...
    let data = {
        ...
        "character": {
            ...
            "Status": {
                ...
                "元素チャージ": Math.round(chara.stats.FIGHT_PROP_CHARGE_EFFICIENCY * 1000) / 10,
            },
            "Talent": {
            ...
            "Score": {
                "State": scoreType,
                "total": await totalCal(chara),
                "flower": await scoreCal(chara.reluquary[0]?.subStats),
                "wing": await scoreCal(chara.reluquary[1]?.subStats),
                "clock": await scoreCal(chara.reluquary[2]?.subStats),
                "cup": await scoreCal(chara.reluquary[3]?.subStats),
                "crown": await scoreCal(chara.reluquary[4]?.subStats)
            },
            "Artifacts": {
            },
        },
