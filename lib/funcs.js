const [artList, effEleList, removeStatList] = ["./data/artList.json", "./data/removeStatList.json"].map(module => require(module));
// 各種jsonの読み込み
...
async function effEle(chara) {
    ...
    keys.forEach(r => {
        /** @type {import("enka-network-api").StatusProperty} */
